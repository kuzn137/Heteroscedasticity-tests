...
class Park_test(Heteroscedasticity_tests):
     ...
     def park_test(self):
         ...
         if pvalue > 0.01:
            return "Park test: P value {} is larger than 0.01, you may not have heteroscedasticity, check the Glejser test".format(pvalue)
         else:
            return "Park test: P value {} is smaller than 0.01, you may have heteroscedasticity".format(pvalue)
